        ...
        <div class="accordion-item">
            ...
            <div class="accordion-body">
                <form action="sklad.php" method="post">
                    Řazení: <select id="orderby" class="form-select" name="orderby">
...
<div class="media-wrapper row">
    <div class="col">
        <div class="prehled-tab container text-center">
            <div class='row header mobile-col'><div class="col">Název</div><div class="col remove-mobile">Množství</div>
            <div class="col remove-mobile">Datum zakoupení</div>
            <div class="col remove-mobile">Obchod</div>
            <div class="col">Prodejní cena</div><div class="col"></div class="remove-mobile"></div>
            <?php foreach($model["zbozi"] as $polozka) : ?>
                <div class='row mobile-col'>
                    <div class="col"><?= $polozka->nazev ?></div>
                    <div class="col remove-mobile"><?= $polozka->mnozstvi ?> <?= $polozka->jednotka ?></div>
                    <div class="col remove-mobile"><?= $polozka->datum ?></div>
                    <div class="col remove-mobile"><?= $polozka->obchod ?></div>
                ...
                <div class="detail-form">
                    <div class="row" style="justify-content: end;">
                        <div class="col" style="max-width: fit-content;">
                            <button type="button" id="detailClose" class="red-but btn-danger btn"
                    ...
                    <div class="row">
                        <div class="col">ID</div><div class="col-md-8">
                            <input id="id" type="text" name="id" readonly class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">Název</div><div class="col-md-8">
                            <input id="nazev" type="text" name="nazev" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">Množství</div><div class="col-md-8">
                            <div class="input-group">
                                <input id="mnozstvi" type="number" name="mnozstvi" min="0" class="form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8"><input id="sercis" type="text" name="sercis" class="form-control"></div>
                    </div>
                    <div class="row">
                        <div class="col">Záruka</div>
                        <div class="col-md-8"><input id="zaruka" type="number" name="zaruka" min="0" class="form-control"></div>
                    </div>
                    <div class="row">
                        <div class="col">Nákupní cena</div>
                        <div class="col-md-8"><input id="cena1" type="number" name="cena1" min="0" step=".001" class="form-control"></div>
                    </div>
                    <div class="row">
                        <div class="col">Prodejní cena</div>
                        <div class="col-md-8"><input id="cena2" type="number" name="cena2" min="0" step=".001" class="form-control"></div>
                    </div>
                    <div class="row">
                        <div class="col">Datum zakoupení</div>
                        <div class="col-md-8"><input id="datum" type="date" name="datum" class="form-control"></div>
                    </div>
                    <div class="row">
                        <div class="col">Obchod</div>
                        <div class="col-md-8"><input id="obchod" type="text" name="obchod" class="form-control"></div>
                    </div>
                    <div class="row">
                        <div class="col">DPH</div>
                        <div class="col-md-8">
                            <div class="input-group">
                                <select class="form-select" id="dph" name="dph">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8"><textarea id="pozn" name="pozn" class="form-control"></textarea></div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col" style="max-width: fit-content;">
                        <input class="edit-but btn" type="submit" name="upravit" value="Upravit" id="edit-but">&nbsp;
                        <button class="del-but btn" formaction="sklad.php" name="smazat" value="Smazat" id="del-but">Smazat</button>
                    </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" data-bs-theme="dark" id="newZboziModal" tabindex="-1" role="dialog"
 aria-labelledby="newZboziModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-5">Množství</div>                    
                    <div class="input-group col">
                        <input name="mnozstvi" class="form-control" type="number" min="0" value="0">
                        <select name="jednotka" class="form-select">
                            <option value="ks">ks</option>
                            <option value="g">g</option>
                            <option value="m">m</option>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="input-group col">
                        <input name="zaruka" class="form-control" type="number" min="0" value="24" required>
                        <span class="input-group-text">Měsíců</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">Nákupní cena</div>
                    <div class="col"><input name="cena1" class="form-control"
                        type="number" min="0" step=".001" required></div>
                </div>
                <div class="row">
                    <div class="col-md-5">Prodejní cena</div>
                    <div class="col"><input name="cena2" class="form-control"
                        type="number" min="0" step=".001" required></div>
                </div>
                <div class="row">
                    <div class="col-md-5">Datum zakoupení</div>
                    <div class="col"><input name="datum" class="form-control"
                        type="date" required></div>
                </div>
                <div class="row">
                    <div class="col-md-5">DPH</div>
                    <div class="input-group col">
                        <select name="dph" class="form-select">
                            <option value="21">21</option>
                            <option value="15">15</option>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col"><input name="obchod" class="form-control" type="text"></div>
                </div>
                <div class="row">
                    <div class="col-md-5">Poznámka</div>
                    <div class="col">
                        <textarea class="form-control" name="pozn">
                        </textarea>
                    </div>
                </div>                                
        </div>
        <div class="modal-footer">
            ...
            <input type="submit" name="pridat" value="Vložit zboží" class="btn blue-but" id="saveModal"></input>
        </div>
        </form>
        </div>             
    </div>
